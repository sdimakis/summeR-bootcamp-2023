...
Thankfully, R follows the order of operations (BEDMAS/PEMDAS/BODMAS/BIDMAS).
...
All of the values computer thus far haven't been stored anywhere though...
...
Open the `01_rstudio_basics.Rmd` file.
...
R Markdown documents end with the extension `.Rmd`. Let's take a look at how they work... `r fontawesome::fa("cloud")`
...
1. Go back to `01_rstudio_basics.Rmd` and click `knit`. Take a look at the resulting file called `01_rstudio_basics.html`. 
