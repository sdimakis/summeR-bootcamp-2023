...
1. Create a list like mine that is made up of `year`, `name`, `enrollment`, `fave_data`, but corresponds to you (year in undergrad, year in grad school, years since PhD, etc.). Name your list using your first name. Make sure you enter two types of favorite data (bc who could choose?!). 
